...
(function($){
	...
	var gf_placeholder = function() {
		...
		$('.gform_wrapper .gf-add-placeholder select.gfield_select').each(function(i){

			var elementID = $(this).attr('id');
			var inIdFormat = "#" + elementID;
			var theLabel = $('label[for=' + elementID + ']').text();
			$(inIdFormat).prepend("<option class='placeholder place-"+it+"' selected disabled value='0'>" + theLabel + "</option>" );
