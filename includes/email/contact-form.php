...
$microcopy = array(
    'upload'      => _x('Choose a file', 'Forms', 'Stack8'),
...
$sendInfo = array(
	...
	"message"     => _x('Contact request from 3d Solid', 'Contact Form', 'Stack8'),
	...
	<div class="wrapper">
		<div class="row">
			<div class="columns small-12">
				<p><?php _ex('Thank you for your contact request, you will be replied to shortly', 'Contact Form', 'Stack8');?></p>
			</div>
		</div>
	</div>
<?php
